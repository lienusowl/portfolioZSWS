...
<div class="modal fade modal-feedback" id="call" tabindex="-1" role="dialog">
  <div class="modal-dialog"> 
    <div class="modal-content"> 
      ...
      <form method="post" action="order.php" id="form-call" name="feedback" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn small" id="send" name="Submit1">Отправить</button>
      </form>
    </div>
  </div>
</div>
