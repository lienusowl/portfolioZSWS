...
<!-- Loading cartjs. -->
<script src="assets/template/cart/popper.min.js"></script>
<script src="assets/template/cart/cart.js"></script>
<script>
  cartjs.initialize({
    baseUrl       : 'http://localhost:8080/zsws/velo/',
    emailOrdersTo : 'admin@zsws.ru',
    language      : 'russian',
    currency      : 'руб.'
  })
</script>
