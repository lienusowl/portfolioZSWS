...
<div id="win1">
   ...
   <p style="font-family: Calibri, 'Open Sans', sans-serif;color: #e94500;font-size: 32px;border-bottom:2px solid color: #e94500;"><strong>Звонок заказан!</strong></p>
   <p  style="font-family: Calibri, 'Open Sans', sans-serif;color: #e94500;font-size: 26px;">Наш менеджер свяжется с Вами в самое ближайшее время и ответит на все интересующие вопросы</p>
   <div style="display:none;">
