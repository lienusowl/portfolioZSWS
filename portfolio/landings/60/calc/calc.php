...
<script>
		function addition() {
			...
			document.getElementById('result').innerHTML =  "<table><tr>		<td width='120px'><p><b>Цена потолка:</b></p></td>		<td><span class='red'>" + c + " руб.<img src='../img/price.png'></span></td>	</tr>	<tr>		<td><p class='red2'>При заказе прямо сейчас ваша цена со скидкой:</p></td>		<td><span class='green'>" + d + " руб.</span></td>	</tr></table><tr><td colspan='2'><a href='#inline1' class='modalbox'>Заказать</a></td></tr>";
		}
		</script>



<table style="background-color: #eee;padding: 15px;    box-shadow: 6px 6px 0px #986b2b;width:430px;">
<form action="order.php" method="post">
	<tr>
		<td width="125px;"><p>Ваш пакет</p></td>
		<td>
