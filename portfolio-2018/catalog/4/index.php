...
<?php include("blocks/header-index.php");?>
<?php include("blocks/partners-index.php");?>
<?php include("blocks/why-index.php");?>
<?php include("blocks/author-index.php");?>
<?php include("blocks/catalog-index.php");?>
