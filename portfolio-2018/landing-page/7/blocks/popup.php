<!--оставить заявку-->
<div class="modal fade modal-feedback md-modal md-effect-8" id="call" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
  <div class="modal-dialog"> 
    <div class="modal-content call"> 
      ...
      <h3>Оставьте заявку<br><span>на бесплатный расчет стоимости</span></h3>
      <form class="form-horizontal ajax-form" id="form-call">
        ...
        <div class="form-group">
          <input type="tel" class="form-control number" id="number" placeholder="Ваш Телефон" name="number" required="">
        </div>
        <div class="clear"></div>
        <button type="submit" class="btn send" id="send" name="submit">отправить</button>
        <div class="clear"></div>
        <p class="alarm">Мы не рассылаем спам, и соблюдаем<br>политику конфиденциальности</p>
      </form>
    </div>
  </div>
</div>
