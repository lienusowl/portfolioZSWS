<!--оставить заявку-->
<div class="modal fade modal-feedback" id="call-popup" tabindex="-1" role="dialog">
	<div class="modal-dialog"> 
		<div class="modal-content"> 
			<button type="button" class="close" data-dismiss="modal"></button>
			<h3>Оставить заявку</h3>
			<form method="post" action="order.php" id="form-call" name="form-call" enctype="multipart/form-data">
				...
				<div class="form-group file">
					<input type="file" class="form-control" name="fileforsending" id="fileforsending">
				</div>
