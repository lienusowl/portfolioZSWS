...
<div id="help-panel" style="display: none;">
    ...
    <div class="main"><a class="title" title="Перейти к форме заказа" href="#contact-wrapper">Перейти к форме заказа</a></div>
    
   
    <!-- Блок перехода к частым вопросам -->   
    <div class="main"><a class="title" title="Скачать инструкцию" href="files/help.pdf" target="_blank">Инструкция по сборке в формате pdf</a></div>
...
<a id="help-button" href="javascript:void(0);"><img alt="" src="img/helper/helper.png"/></a>
